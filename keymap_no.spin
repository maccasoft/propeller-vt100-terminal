...
keymap
    ...
    word    "e",               "E",               $80,               kb#KeyNone         ' 0x08   $80 euro
    ...
    word    "m",               "M",               $B5,               kb#KeyNone         ' 0x10   $B5 micro
    ...
    word    "2",               $22,               "@",               kb#KeyNone         ' 0x1F  $22 double quotation mark
    word    "3",               $23,               $A3,               kb#KeyNone         ' 0x20  $23 hash tag      $A3 pound
    word    "4",               $A4,               "$",               kb#KeyNone         ' 0x21  $A4 currency sign
    word    "5",               "%",               kb#KeyNone,        kb#KeyNone         ' 0x22
    word    "6",               "&",               kb#KeyNone,        kb#KeyNone         ' 0x23
    word    "7",               "/",               "{",               kb#KeyNone         ' 0x24
    word    "8",               "(",               "[",               kb#KeyNone         ' 0x25
    word    "9",               ")",               "]",               kb#KeyNone         ' 0x26
    word    "0",               "=",               "}",               kb#KeyNone         ' 0x27
    ...
    word    $C6,               $E6,               kb#KeyNone,        kb#KeyNone         ' 0x34   $C6 Æ   $E6 æ
    word    "|",               $A7,               kb#KeyNone,        kb#KeyNone         ' 0x35   $A7 §
