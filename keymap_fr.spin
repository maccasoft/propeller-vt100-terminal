...
keymap
    ...
    word    "z",               "Z",               kb#KeyNone,        kb#KeyNone         ' 0x1A
    word    "x",               "X",               kb#KeyNone,        kb#KeyNone         ' 0x1B
    word    "y",               "Y",               kb#KeyNone,        kb#KeyNone         ' 0x1C
    word    "w",               "W",               kb#KeyNone,        kb#KeyNone         ' 0x1D
    word    "&",               "1",               kb#KeyNone,        kb#KeyNone         ' 0x1E
    word    $82,               "2",               "~",               kb#KeyNone         ' 0x1F
    word    $22,               "3",               "#",               kb#KeyNone         ' 0x20
    word    "'",               "4",               "{",               kb#KeyNone         ' 0x21
    word    "(",               "5",               "[",               kb#KeyNone         ' 0x22
    word    "-",               "6",               "|",               kb#KeyNone         ' 0x23
    word    $8A,               "7",               "`",               kb#KeyNone         ' 0x24
    word    "_",               "8",               "\",               kb#KeyNone         ' 0x25
    word    $87,               "9",               "^",               kb#KeyNone         ' 0x26
    word    $A0,               "0",               "@",               kb#KeyNone         ' 0x27
    ...
    word    ")",               $F8,               "]",               kb#KeyNone         ' 0x2D
    word    "=",               "+",               "}",               kb#KeyNone         ' 0x2E
    word    "^",               kb#KeyNone,        kb#KeyNone,        kb#KeyNone         ' 0x2F
    word    "$",               $9C,               kb#KeyNone,        kb#KeyNone         ' 0x30
    word    "*",               $E6,               kb#KeyNone,        kb#KeyNone         ' 0x31
    word    "*",               $E6,               kb#KeyNone,        kb#KeyNone         ' 0x32
    word    "m",               "M",               kb#KeyNone,        kb#KeyNone         ' 0x33
    word    $97,               "%",               kb#KeyNone,        kb#KeyNone         ' 0x34
    word    $FD,               kb#KeyNone,        kb#KeyNone,        kb#KeyNone         ' 0x35
    word    ";",               ".",               kb#KeyNone,        kb#KeyNone         ' 0x36
    word    ":",               "/",               kb#KeyNone,        kb#KeyNone         ' 0x37
    word    "!",               $15,               kb#KeyNone,        kb#KeyNone         ' 0x38
